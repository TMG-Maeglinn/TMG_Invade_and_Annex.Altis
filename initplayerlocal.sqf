...
//--------------------- Billboard Image Randomiser
	...
	if (_bill1 == 5) then {Bill_1 setObjectTexture [0,"tmg_custom\media\images\billboard5.paa"]};
	if (_bill1 == 6) then {Bill_1 setObjectTexture [0,"tmg_custom\media\images\billboard6.paa"]};


	_imageList2 = [1,2,3,4,5];
	...
	if (_bill2 == 5) then {Bill_2 setObjectTexture [0,"tmg_custom\media\images\billboard5.paa"]};
...
if (_email == "join@tacticalmilitarygaming.com") then {

_GlobalHint = format["<t align='center' size='2.2' color='#FF0000'>%1<br/></t><t size='1.4' color='#33CCFF'>%2</t><br/>has joined the server, To get involved in our community, register an account at www.tacticalmilitarygaming.com and get stuck in!</t><br/>",_squad,_name];
